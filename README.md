...
- **🔑 `,ck <duration>`**: Generate keys with custom durations (e.g. `,ck 7 days`, `,ck 24h`, `,ck lifetime`). Syncs immediately to GitHub and logs creation to `<#1550571106497470584>`. Restricted to role ID `1550567704925044858`.
